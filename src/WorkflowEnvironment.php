...
final class WorkflowEnvironment
{
    ...
    {
        $this->await($this->context->delay($seconds));
    }

    public function timer(float $seconds): void
    {
        $this->await($this->context->timer($seconds));
    }
    ...
    {
        $this->context->continueAsNew($workflowType, $payload);
    }
