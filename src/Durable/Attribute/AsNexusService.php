 ...
 *
 * Le nom porté ici est celui que le serveur route : c'est lui, et le nom d'opération de chaque
 * méthode, qui adressent une tâche entrante. Rien d'autre ne l'identifie.
 *
