 ...
 * defaut, y compris dans un worker autonome et dans un test : `env()` existe, puisqu'il vient
...
return [
     ...
     */
    'temporal' => [
        // Le banc n'a pas de grappe à lui : celle de la démonstration est passée par
        // l'environnement, comme les deux autres maquettes le font pour la leur.
        'dsn' => env('DURABLE_DSN'),
    ],
