...
use integration\Gplanchat\Durable\Support\Constraint\DistributedWorkflowJournalEquivalentConstraint;
...
abstract class DurableTestCase extends TestCase
{
    ...
    /**
     * @param list<array{name: string, payload: array<string, mixed>}> $expectedOrdered activités en file (ordre FIFO)
     */
