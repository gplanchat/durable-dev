...
use integration\Gplanchat\Durable\Support\StepwiseWorkflowHarness;
use integration\Gplanchat\Durable\Support\Workflow\BadChildWorkflow;
use integration\Gplanchat\Durable\Support\Workflow\ChildWorkflow;
use integration\Gplanchat\Durable\Support\Workflow\EchoChildWorkflow;
use integration\Gplanchat\Durable\Support\Workflow\ParentCollidingChildWorkflow;
use integration\Gplanchat\Durable\Support\Workflow\ParentOfBadChildWorkflow;
use integration\Gplanchat\Durable\Support\Workflow\ParentReportsChildFailureKindWorkflow;
use integration\Gplanchat\Durable\Support\Workflow\ParentWorkflow;
use integration\Gplanchat\Durable\Support\Workflow\ParWithOptsWorkflow;
use integration\Gplanchat\Durable\Support\Workflow\ReturnOneWorkflow;
...
final class TemporalParityFeaturesTest extends DurableTestCase
{
    ...
    public function eventSerializerRoundTripsNewWorkflowEvents(): void
    {
        $cases = [
            ...
            new WorkflowUpdateHandled('p1', 'up', ['i' => 1], null),
    ...
    public function eventSerializerHydratesLegacyChildWorkflowScheduledWithoutNewFields(): void
    {
        ...
        self::assertSame([], $event->schedulingMetadata());
    }
}
