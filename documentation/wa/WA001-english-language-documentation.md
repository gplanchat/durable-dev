...
2. **Specifications and architecture** — ADRs (`documentation/adr/`), working agreements (`documentation/wa/`), OSTs, and `documentation/LIFECYCLE.md` (and updates to `documentation/INDEX.md`).
...
- The agent must prefer English for any new text in `.cursor/rules/` and `documentation/`.
