...
detail: a timeline that positions each event by the time it was recorded, one lane per kind of
operation, and the journal beneath it. Each journal line unfolds onto what the backend recorded with
