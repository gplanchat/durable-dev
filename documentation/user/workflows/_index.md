...
`#[UpdateMethod]`. There is no way to register one imperatively — the engine wires what you
declare, and a second way to declare a handler would be a second way to get it wrong.
