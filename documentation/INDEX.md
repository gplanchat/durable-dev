...
| DUR035 | Run observation is a projection, and an absent fact stays absent | [adr/DUR035-run-observation-as-a-projection.md](adr/DUR035-run-observation-as-a-projection.md) |
