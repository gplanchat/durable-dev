...
- [x] 6.2 `documentation/user/nexus/_index.{md,fr.md}` : la section devient « Quatre applications, en
      ...
      Symfony). Vérifié sur un build `--minify` servi en HTTP, les deux langues symétriques : **8 `h2`,
      8 `h3`, 2 tableaux, 15 blocs de code** de chaque côté, et le tableau des maquettes rend ses cinq
      colonnes.
