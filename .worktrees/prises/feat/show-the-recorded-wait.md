...
- **Scope**: #324, reopened. The wait the catalogues record (`WorkflowRunDescription::$waitingOn`,
  ...
  grid and detail page, and the Symfony bench dashboard; the profiler panel is out (alice's call:
  no catalogue to read by id until #264). Reuse the existing field, no new port method. Temporal not
...
- **State**: in review — PR #542 (Refs #324), reviewer vera. sabrina.
