...
| `feat/nexus-history-reading` | temporal-nexus-support | 4.3 (lecture des neuf NEXUS_OPERATION_*) | en cours |
| `feat/nexus-async-out-of-scope` | temporal-nexus-support | 4.5 (operation asynchrone hors perimetre) | en cours |
